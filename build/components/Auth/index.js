    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, service_1.default.createUser(req.body)];
                case 1:
                    user = _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, service_1.default.getUser(req.body)];
                case 1:
                    user = _a.sent();
                    token = jwt.sign({ email: user.email }, "".concat(process.env.SECRET), {
                        expiresIn: '60m'
                    });
                    // Corpo devolvido caso a requisição sejá bem sucedida.
                    if (user)
                        res.status(200).json({ logged: true, message: 'Login realizado com sucesso', token: token });
                    return [3 /*break*/, 3];
                case 2:
                    error_2 = _a.sent();
